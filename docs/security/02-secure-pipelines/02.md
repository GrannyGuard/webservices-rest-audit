...
- Queries: `security-and-quality` — detecteert hardcoded credentials, zwakke
  hash-algoritmen en onveilige authenticatiepatronen
...
| **A.8.5** Authenticatie | SAST | CodeQL detecteert hardcoded credentials, zwakke hash-algoritmen | `.github/workflows/codeql.yml:48` — `queries: security-and-quality` |
