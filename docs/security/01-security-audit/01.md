...
| ID | Omschrijving | Kans | Impact | Score | Classificatie | Betrokken KJ |
|:---|:-------------|:----:|:------:|:-----:|:--------------|:-------------|
| **SQ1** | Kwetsbare sessie-validatie | 3 | 5 | **15** | 🔴 Hoog | KJ3, KJ1, KJ2 |
| **SQ2** | Onvolledige switch-statements | 4 | 4 | **16** | 🔴 Hoog | KJ2 |
| **SQ3** | Foute testassertions | 5 | 3 | **15** | 🔴 Hoog | KJ2 |
| **SQ4** | Niet-serializeerbaar validatie-veld | 3 | 3 | **9** | 🟠 Midden | KJ5 |
| **SQ5** | Extreem hoge cognitieve complexiteit | 5 | 2 | **10** | 🟠 Midden | KJ5 |
| **SQ6** | Lege methoden zonder verklaring | 4 | 2 | **8** | 🟡 Laag-Midden | — |
| **CD1** | Supply chain attack | 3 | 5 | **15** | 🔴 Hoog | KJ7, KJ1, KJ2 |
| **CD2** | Lekkage van secrets | 3 | 4 | **12** | 🔴 Hoog | KJ7, KJ3 |
| **CD3** | Ongeautoriseerde toegang repository/pipeline | 2 | 5 | **10** | 🟠 Midden | KJ7 |
| **CD4** | Foutieve beveiligingsconfiguratie | 3 | 3 | **9** | 🟠 Midden | KJ7 |
| **CD5** | Uitval CI/CD-omgeving | 4 | 2 | **8** | 🟡 Laag-Midden | KJ5 |
| **CD6** | Malafide code contributor | 2 | 5 | **10** | 🟠 Midden | KJ7, KJ1, KJ2 |

De hoogst scorende risico's zijn **SQ2** (score 16) en **SQ1**, **SQ3**, **CD1** (score 15).
