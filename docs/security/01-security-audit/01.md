...
De hoogst scorende risico's zijn **SQ7** (score 20, nieuwe bevinding uit de threat-modelling §3.5), **SQ2** (score 16) en **SQ1**, **SQ3**, **CD1** (score 15). Dertien van de vijftien risico's vallen in de categorie Midden of hoger; acht zijn Onacceptabel (vijf 🔴 Hoog + drie ⚠️-gemarkeerde Midden-risico's die KJ1/KJ2/KJ3 raken met score ≥ 10).
