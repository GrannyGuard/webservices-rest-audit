...
zijn er \textbf{twee volledig gemitigeerd en geverifieerd} (B-004: reflected XSS; B-005: log injection) en is \textbf{één deels gemitigeerd}
...
bevindingen zijn \textbf{nog open}: B-001 (ongeauthenticeerde uitlezing van alle
systeemconfiguratie, risicoscore 20, hoogste van de analyse) en B-003 (geen
brute-force-bescherming op authenticatie) en
...
sessie-fixatie CWE-384 staat nog open), en B-004 en B-005 zijn gemitigeerd; B-005 toont een volledig afgesloten detect-\,$\to$\,mitigeer-\,$\to$\,verifieer-cyclus.
...
in commit; 12 geautomatiseerde filtertests slagen.
