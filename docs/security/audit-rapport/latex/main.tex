...
Het normenkader voor deze audit is NEN-7510:2024 Deel 2. De audit richt
zich op vijf controls: A.8.3 (toegangsbeveiliging), A.8.5 (authenticatie),
A.8.8 (beheer van technische kwetsbaarheden), A.8.15 (logging) en A.8.25
(veilige ontwikkelcyclus). De volledige koppeling tussen deze controls en
de traceerbare bewijsartefacten is opgenomen in de traceability matrix
