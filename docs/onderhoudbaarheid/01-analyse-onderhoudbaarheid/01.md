...
Hoge cognitive complexity heeft vooral invloed op *analyseerbaarheid* — diep geneste code is veel moeilijker te volgen bij het zoeken naar bugs — en op *aanpasbaarheid*, omdat complexe logica de kans op onbedoelde neveneffecten vergroot bij wijzigingen.
