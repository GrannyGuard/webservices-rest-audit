...
| **Bugfix als bijvangst** | Origineel: `concepts.add(concept)` staat vóór de null-check — bij een onbekend concept belandt `null` in de lijst; na refactoring retourneert `searchByExactName` direct `EmptySearchResult()` als `concept == null` |
