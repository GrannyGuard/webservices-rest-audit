...
De volledige `omod`-suite telt **1.828 tests** (1 falend, 14 geskipt; de ene fail is de bekende, versie-gerelateerde test — zie de CI-noot bij Code coverage). De endpoints van onze twee handlers worden o.a. gedekt door:
