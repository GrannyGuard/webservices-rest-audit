...
public class UserResource1_8 extends MetadataDelegatingCrudResource<UserAndPassword1_8> {
	...
	public UserAndPassword1_8 getByUniqueId(String uuid) {
		...
		return user != null ? new UserAndPassword1_8(user) : null;
	}
	 ...
	 * 
	 * @see org.openmrs.module.webservices.rest.web.resource.impl.BaseDelegatingResource#getUniqueId(Object)
	 */
	@Override
	 ...
	 * 
	 * @see MetadataDelegatingCrudResource#getAuditInfo(Object)
	 */
